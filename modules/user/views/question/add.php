...
<div class="span10" id="datacontent">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="/user/discuss/index">问答管理</a> <span class="divider">/</span></li>
        <li class="active">添加问题</li>
    </ul>
    <form action="/user/question/add" method="post" class="form-horizontal">
        <fieldset>
            <input type="hidden" value="1" name="question[type]">
            <input type="hidden" value="<?php echo date('Y-m-d H:i:s', time());?>" name="question[addTime]">
            ...
            <div class="control-group">
                <label for="area" class="control-label">提问用户ID：</label>
                <div class="controls">
                    <input type="text" value="" name="question[userId]">
                </div>
            </div>
            <div class="control-group">
                <label for="area" class="control-label">关注数量：</label>
                <div class="controls">
                    <textarea name="question[follow]"></textarea>
                </div>
            </div>
            <div class="control-group">
                <label for="area" class="control-label">浏览量：</label>
                <div class="controls">
                    <textarea name="question[browse]"></textarea>
                </div>
            </div>
            <div class="control-group">
