...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 196, height: 287, top: 20, left: -85, $opacity: 0.5 },
            { '&zIndex': 2, width: 206, height: 297, top: 15, left: 134, $opacity: 0.5 },
            { '&zIndex': 3, width: 216, height: 307, top: 10, left: 0, $opacity: 0.6 },
            { '&zIndex': 4, width: 226, height: 317, top: 5, left: 110, $opacity: 0.7 },
            { '&zIndex': 5, width: 236, height: 327, top: 0, left: 262, $opacity: 1 },
            { '&zIndex': 4, width: 220, height: 317, top: 5, left: 468, $opacity: 0.7 },
            { '&zIndex': 3, width: 216, height: 307, top: 10, left: 620, $opacity: 0.6 },
            { '&zIndex': 2, width: 206, height: 297, top: 15, left: 496, $opacity: 0.5 },
            { '&zIndex': 1, width: 196, height: 287, top: 20, left: 727, $opacity: 0.5 }
        ]
