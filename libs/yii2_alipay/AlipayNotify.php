...
use app\libs\yii2_alipay\AlipayCore;
use app\libs\yii2_alipay\AlipayMD5;
use app\libs\yii2_alipay\AlipayRsa;
	...
	function getSignVeryfy($para_temp, $sign) {
		...
		switch (strtoupper(trim($this->alipay_config['sign_type']))) {
			case "MD5" :
				...
				break;
            case "RSA" :
                $isSgin = AlipayRsa::rsaSign($prestr, trim($this->alipay_config['private_key_path']));
                break;
			default :
				$isSgin = false;
		}
